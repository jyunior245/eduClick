export class EditarPerfilProfessorPage {
  static render(professor: any): string {
    return `
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="conteudosDominio" name="conteudosDominio" value="${professor.conteudosDominio?.join(', ') || ''}" placeholder="Ex: Matemática, Física, Química" autocomplete="off">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="segunda" name="diasDisponiveis" value="segunda" ${professor.diasDisponiveis?.includes('segunda') ? 'checked' : ''}>
                            <label class="form-check-label" for="segunda">Segunda-feira</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="terca" name="diasDisponiveis" value="terca" ${professor.diasDisponiveis?.includes('terca') ? 'checked' : ''}>
                            <label class="form-check-label" for="terca">Terça-feira</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="quarta" name="diasDisponiveis" value="quarta" ${professor.diasDisponiveis?.includes('quarta') ? 'checked' : ''}>
                            <label class="form-check-label" for="quarta">Quarta-feira</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="quinta" name="diasDisponiveis" value="quinta" ${professor.diasDisponiveis?.includes('quinta') ? 'checked' : ''}>
                            <label class="form-check-label" for="quinta">Quinta-feira</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="sexta" name="diasDisponiveis" value="sexta" ${professor.diasDisponiveis?.includes('sexta') ? 'checked' : ''}>
                            <label class="form-check-label" for="sexta">Sexta-feira</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="sabado" name="diasDisponiveis" value="sabado" ${professor.diasDisponiveis?.includes('sabado') ? 'checked' : ''}>
                            <label class="form-check-label" for="sabado">Sábado</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="domingo" name="diasDisponiveis" value="domingo" ${professor.diasDisponiveis?.includes('domingo') ? 'checked' : ''}>
