...
export class DashboardProfessorPage {
  static render(usuario: any, aulas: any[] = []): string {
    return `
                      ...
                      <div class="card-body">
                        ...
                        <div class="row mb-3">
                          <div class="col-6">
                            ...
                            <div class="fw-semibold">${aula.vagasRestantes ?? (aula.maxAlunos - (aula.alunosReservados?.length || 0))} / ${aula.maxAlunos}</div>
                          </div>
                          <div class="col-6">
                          ...
                          <div class="accordion-item">
                            <h2 class="accordion-header">
                              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-${aula.id}">
                                <i class="bi bi-people"></i> Reservas (${aula.reservas?.length || 0})
                              </button>
                            </h2>
                            <div id="collapse-${aula.id}" class="accordion-collapse collapse" data-bs-parent="#accordion-${aula.id}">
                              <div class="accordion-body p-0">
                                <ul class="list-group list-group-flush">
                                  ${(aula.reservas && aula.reservas.length > 0)
                                    ? aula.reservas.map((reserva: any, idx: number) => `
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                          <div>
                                            <div class="fw-semibold">${reserva.nome}</div>
                                            <small class="text-muted">${reserva.telefone}</small>
                                          </div>
                                          <button class="btn btn-sm btn-outline-danger" onclick="cancelarReserva('${aula.id}', '${reserva.nome}', '${reserva.telefone}')">
