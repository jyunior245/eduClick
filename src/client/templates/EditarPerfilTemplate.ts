              ...
              <div class="card-body p-4">
                ...
                <form id="form-editar-perfil" onsubmit="${params.onSubmit || 'handleEditarPerfilSubmit'}(event)">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="bio" name="bio" rows="4" placeholder="Conte um pouco sobre você e sua experiência...">${usuario.bio || ''}</textarea>
                  </div>
                  <div class="row g-3">
                    <div class="col-md-6 mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="observacoes" name="observacoes" rows="3" placeholder="Informações adicionais sobre suas aulas...">${usuario.observacoes || ''}</textarea>
                  </div>
