...
exports.ProfessorPublicoPage = void 0;
class ProfessorPublicoPage {
    static render(professor, aulas) {
        return `
              ...
              <div class="col">
                <div class="card h-100 shadow-sm">
                  <div class="card-body">
                    ...
                    <p class="mb-1"><b>Valor:</b> R$ ${((_a = aula.valor) === null || _a === void 0 ? void 0 : _a.toFixed(2)) || '-'}</p>
                    <p class="mb-1"><b>Vagas:</b> ${(_b = aula.vagasRestantes) !== null && _b !== void 0 ? _b : (aula.maxAlunos - (((_c = aula.alunosReservados) === null || _c === void 0 ? void 0 : _c.length) || 0))} / ${aula.maxAlunos}</p>
...
exports.ProfessorPublicoPage = ProfessorPublicoPage;
